...
const githubStarsUrl = "https://github.com/etng/echarts-demo/stargazers";
    ...
    <main className="h-screen overflow-hidden bg-[var(--background)] text-[var(--foreground)]">
      <div className="grid h-full min-w-[1100px] grid-cols-[420px_minmax(0,1fr)]">
        <aside className="flex h-screen min-h-0 flex-col border-r border-[var(--border)] bg-[var(--surface)]">
          ...
          <footer className="flex shrink-0 justify-center border-t border-[var(--border-subtle)] px-5 py-4">
            <a
              href={githubStarsUrl}
              target="_blank"
              rel="noreferrer"
              aria-label="在 GitHub 上给项目 Star"
              title="在 GitHub 上给项目 Star"
              className="inline-flex size-10 items-center justify-center rounded-md text-[var(--muted)] transition hover:bg-[var(--surface-muted)] hover:text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-ring)]"
            >
              <svg role="img" aria-hidden="true" viewBox="0 0 24 24" className="size-5" fill="currentColor">
